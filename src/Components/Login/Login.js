...
export default class Login extends Component {
  ...
  handleSubmit = event => {
    ...
    function getAccountData(){ //calls the server
      return Promise.all([fetch('http://ponceplayer.com:5000/account_data').then(response => response.json())]) //gets the json object
    }
  ...
  newUser = event =>{
    ...
    fetch('http://ponceplayer.com:5000/add_user',{
      method: 'POST',
